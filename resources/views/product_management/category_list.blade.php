                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end mb-2">
                                <button class="btn btn-eco btn-sm btn-round has-ripple" data-bs-toggle="modal" data-bs-target="#modal-report"><i class="feather icon-plus"></i> Add Category</button>
                            </div>
                            @endif
                        </div>
...
<div class="modal fade" id="edit_category" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit_category_data" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(document).on('submit', '#add_category', function(ev) {
        $('.error').html('');
