                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Sub Sub Category</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('') }}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Product Management</a></li>
                            <li class="breadcrumb-item"><a href="#">Sub Sub Category</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end mb-2">
                                <button class="btn btn-eco btn-sm btn-round has-ripple" data-bs-toggle="modal" data-bs-target="#modal-report"><i class="feather icon-plus"></i> Add Sub Sub Category</button>
                            </div>
                            @endif
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_subsubcategory" method="post" enctype="multipart/form-data">
                    @csrf()
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label" for="Name">Select Service Type</label>
                                <select class="form-select" name="service_type" id="service_type" onchange="get_ser_cat(this.value)">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-select service_category" name="cat_id" id="cat_id" onchange="getsubcat(this.value);">
                                </select>
...
<div class="modal fade" id="edit_subsubcategory" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit_sub_sub_category_data" method="post" enctype="multipart/form-data">

                    <div id="editsubsubcategorydiv"></div>
...
<script>
    ...
    $(document).on('submit', '#add_subsubcategory', function(ev) {
        $('.error').html('');
